...
function SwiperInner({
  ...
  const onMomentumScrollEnd = (0, _react.useCallback)(e => {
    ...
    const newIndex = isHorizontal ? Math.round(contentOffset.x / viewSize.width) : (0, _Month.getIndexFromVerticalOffset)(contentOffset.y - _dateUtils.beginOffset, startWeekOnMonday);
    if (newIndex === 0) {
      return;
    }
